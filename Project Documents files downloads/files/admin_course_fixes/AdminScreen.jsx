...
export default function AdminScreen({ onBack, onJoinAsAdmin }) {
  ...
  if (!authed) {
    return (
      <div style={{ maxWidth: 420, margin: "0 auto", padding: "32px 16px", fontFamily: "Georgia, serif" }}>
        ...
        <h2 style={{ color: sc.green, marginBottom: 24 }}>Admin Access</h2>
        <input
          type="password"
          value={pin}
        ...
        <button onClick={handlePin} style={{ width: "100%", padding: "10px", fontSize: 15, fontWeight: 700, background: sc.green, color: "#fff", border: "none", borderRadius: 8, cursor: "pointer", fontFamily: "inherit" }}>
          Enter
        </button>
      </div>
    );
